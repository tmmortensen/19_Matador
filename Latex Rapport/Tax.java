...
public class Tax extends Field{
	...
	/**
	 * 2 of 2 constructors. Used for fields that has both fixed amount and percentage of assets as tax.
	 * Takes more arguments, to be able to get other fields, and to be able to ask user for fixed or percentage.
	 *
	 * @param name The name of this field.
	 ...
	 * @param scanner A scanner to use for console input.
	 */
	 ...
	 * Ask player for fixed/percentage if available, and subtracts score accordingly.
	 */
